                        ...
                        <div class="modal-body" align="center">
                            ...
                            if (isset($_POST["TblSimpan"])) {
                                ...
                                if ($db->connect_errno == 0) {
                                    ...
                                    $nama_jenis_barang  = $db->escape_string($_POST["nama_jenis_barang"]);
                                    // query update data
                                    $sql = "INSERT INTO `jenis_barang` (`kode_jenis_barang`, `nama_jenis_barang`)
                                    VALUES ('$kode_jenis_barang', '$nama_jenis_barang')";
                            ...
                            ?>
                                            ...
                                            <div class="modal-footer">
                                                <a href="jenis_barang.php"><button class="btn btn-primary">Ok</button></a>
                                            </div>
                                        <?php
                                        }
                                    } else {
