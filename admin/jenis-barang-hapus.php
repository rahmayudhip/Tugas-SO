                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" align="center">
                            <?php
                            if (isset($_GET["kode_jenis_barang"])) {
                                $db = dbConnect();
                                if ($db->connect_errno == 0) {
                                    $kode_jenis_barang = $db->escape_string($_GET["kode_jenis_barang"]);
                                    // query hapus
                                    $sql = "DELETE FROM `jenis_barang` WHERE kode_jenis_barang='$kode_jenis_barang'";
                                    // eksekusi query
                                    $res = $db->query($sql);
                                    if ($res) {
